...
contract SolnSquareVerifier is MayankERC721Token {
    ...
    function addingtheSolutions(uint256 _tokenId, address _to, bytes32 key) internal {
            ...
            uint[2] memory input) public 
    {
        ...
        addingtheSolutions(tokenId, to, key);
    }
